...
class Module:
    ...
    def main(args: T.handle, arg_type_ids: T.handle("int32"), num_args: T.int32, out_ret_value: T.handle("void"), out_ret_tcode: T.handle("int32"), resource_handle: T.handle) -> T.int32:
        ...
        w_flat: T.handle("float16", "global") = T.tvm_struct_get(kernel_handle, 0, 1, "handle")
        T.attr(w_flat, "storage_alignment", 64)
        ...
        assert T.Cast("int32", main_data_handle_shape_1[0]) == 100, "Argument main.data_handle.shape[0] has an unsatisfied constraint: 100 == T.Cast(\"int32\", main_data_handle_shape[0])"
        assert T.Cast("int32", main_data_handle_shape_1[1]) == 224, "Argument main.data_handle.shape[1] has an unsatisfied constraint: 224 == T.Cast(\"int32\", main_data_handle_shape[1])"
        assert T.Cast("int32", main_data_handle_shape_1[2]) == 224, "Argument main.data_handle.shape[2] has an unsatisfied constraint: 224 == T.Cast(\"int32\", main_data_handle_shape[2])"
        assert T.Cast("int32", main_data_handle_shape_1[3]) == 3, "Argument main.data_handle.shape[3] has an unsatisfied constraint: 3 == T.Cast(\"int32\", main_data_handle_shape[3])"
        ...
        assert T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast("int32", main_data_handle_shape_1[3]), T.Cast("int32", main_data_handle_strides_1[2])) == 3, "Argument main.data_handle.strides[2] has an unsatisfied constraint: 3 == T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast(\"int32\", main_data_handle_shape[3]), T.Cast(\"int32\", main_data_handle_strides_1[2]))"
        assert T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast("int32", main_data_handle_shape_1[3]) * T.Cast("int32", main_data_handle_shape_1[2]), T.Cast("int32", main_data_handle_strides_1[1])) == 672, "Argument main.data_handle.strides[1] has an unsatisfied constraint: 672 == T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast(\"int32\", main_data_handle_shape[3]) * T.Cast(\"int32\", main_data_handle_shape[2]), T.Cast(\"int32\", main_data_handle_strides_1[1]))"
        assert T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast("int32", main_data_handle_shape_1[3]) * T.Cast("int32", main_data_handle_shape_1[2]) * T.Cast("int32", main_data_handle_shape_1[1]), T.Cast("int32", main_data_handle_strides_1[0])) == 150528, "Argument main.data_handle.strides[0] has an unsatisfied constraint: 150528 == T.if_then_else(T.isnullptr(main_data_handle_strides), T.Cast(\"int32\", main_data_handle_shape[3]) * T.Cast(\"int32\", main_data_handle_shape[2]) * T.Cast(\"int32\", main_data_handle_shape[1]), T.Cast(\"int32\", main_data_handle_strides_1[0]))"
        ...
        assert T.Cast("int32", main_kernel_handle_shape_1[0]) == 11, "Argument main.kernel_handle.shape[0] has an unsatisfied constraint: 11 == T.Cast(\"int32\", main_kernel_handle_shape[0])"
        assert T.Cast("int32", main_kernel_handle_shape_1[1]) == 11, "Argument main.kernel_handle.shape[1] has an unsatisfied constraint: 11 == T.Cast(\"int32\", main_kernel_handle_shape[1])"
        assert T.Cast("int32", main_kernel_handle_shape_1[2]) == 3, "Argument main.kernel_handle.shape[2] has an unsatisfied constraint: 3 == T.Cast(\"int32\", main_kernel_handle_shape[2])"
        assert T.Cast("int32", main_kernel_handle_shape_1[3]) == 96, "Argument main.kernel_handle.shape[3] has an unsatisfied constraint: 96 == T.Cast(\"int32\", main_kernel_handle_shape[3])"
        ...
        assert T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast("int32", main_kernel_handle_shape_1[3]), T.Cast("int32", main_kernel_handle_strides_1[2])) == 96, "Argument main.kernel_handle.strides[2] has an unsatisfied constraint: 96 == T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast(\"int32\", main_kernel_handle_shape[3]), T.Cast(\"int32\", main_kernel_handle_strides_1[2]))"
        assert T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast("int32", main_kernel_handle_shape_1[3]) * T.Cast("int32", main_kernel_handle_shape_1[2]), T.Cast("int32", main_kernel_handle_strides_1[1])) == 288, "Argument main.kernel_handle.strides[1] has an unsatisfied constraint: 288 == T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast(\"int32\", main_kernel_handle_shape[3]) * T.Cast(\"int32\", main_kernel_handle_shape[2]), T.Cast(\"int32\", main_kernel_handle_strides_1[1]))"
        assert T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast("int32", main_kernel_handle_shape_1[3]) * T.Cast("int32", main_kernel_handle_shape_1[2]) * T.Cast("int32", main_kernel_handle_shape_1[1]), T.Cast("int32", main_kernel_handle_strides_1[0])) == 3168, "Argument main.kernel_handle.strides[0] has an unsatisfied constraint: 3168 == T.if_then_else(T.isnullptr(main_kernel_handle_strides), T.Cast(\"int32\", main_kernel_handle_shape[3]) * T.Cast(\"int32\", main_kernel_handle_shape[2]) * T.Cast(\"int32\", main_kernel_handle_shape[1]), T.Cast(\"int32\", main_kernel_handle_strides_1[0]))"
        ...
        assert not T.isnullptr(w_flat), "main.kernel_handle is expected to have non-NULL data pointer"
        ...
        assert T.Cast("int32", main_out_handle_shape_1[0]) == 100, "Argument main.out_handle.shape[0] has an unsatisfied constraint: 100 == T.Cast(\"int32\", main_out_handle_shape[0])"
        assert T.Cast("int32", main_out_handle_shape_1[1]) == 55, "Argument main.out_handle.shape[1] has an unsatisfied constraint: 55 == T.Cast(\"int32\", main_out_handle_shape[1])"
        assert T.Cast("int32", main_out_handle_shape_1[2]) == 55, "Argument main.out_handle.shape[2] has an unsatisfied constraint: 55 == T.Cast(\"int32\", main_out_handle_shape[2])"
        assert T.Cast("int32", main_out_handle_shape_1[3]) == 96, "Argument main.out_handle.shape[3] has an unsatisfied constraint: 96 == T.Cast(\"int32\", main_out_handle_shape[3])"
        ...
        assert T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast("int32", main_out_handle_shape_1[3]), T.Cast("int32", main_out_handle_strides_1[2])) == 96, "Argument main.out_handle.strides[2] has an unsatisfied constraint: 96 == T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast(\"int32\", main_out_handle_shape[3]), T.Cast(\"int32\", main_out_handle_strides_1[2]))"
        assert T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast("int32", main_out_handle_shape_1[3]) * T.Cast("int32", main_out_handle_shape_1[2]), T.Cast("int32", main_out_handle_strides_1[1])) == 5280, "Argument main.out_handle.strides[1] has an unsatisfied constraint: 5280 == T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast(\"int32\", main_out_handle_shape[3]) * T.Cast(\"int32\", main_out_handle_shape[2]), T.Cast(\"int32\", main_out_handle_strides_1[1]))"
        assert T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast("int32", main_out_handle_shape_1[3]) * T.Cast("int32", main_out_handle_shape_1[2]) * T.Cast("int32", main_out_handle_shape_1[1]), T.Cast("int32", main_out_handle_strides_1[0])) == 290400, "Argument main.out_handle.strides[0] has an unsatisfied constraint: 290400 == T.if_then_else(T.isnullptr(main_out_handle_strides), T.Cast(\"int32\", main_out_handle_shape[3]) * T.Cast(\"int32\", main_out_handle_shape[2]) * T.Cast(\"int32\", main_out_handle_shape[1]), T.Cast(\"int32\", main_out_handle_strides_1[0]))"
        ...
        data_1 = T.decl_buffer((100, 224, 224, 3), "float16", data=data, strides=(150528, 672, 3, 1))
        kernel = T.decl_buffer((11, 11, 3, 96), "float16", data=w_flat, strides=(3168, 288, 96, 1))
        out = T.decl_buffer((100, 55, 55, 96), "float16", data=out_flat, strides=(290400, 5280, 96, 1))
        assert T.FloorMod(3, 8) == 0, "data: Vectorize dimension in buffer must be divisible by 8"
        assert T.FloorMod(96, 8) == 0, "kernel: Vectorize dimension in buffer must be divisible by 8"
        assert T.FloorMod(96, 8) == 0, "out: Vectorize dimension in buffer must be divisible by 8"
        T.call_packed("__tvm_set_device", 2, dev_id)
        with T.attr(0, "compute_scope", "main_compute_"):
            T.call_packed("main_kernel", data, out_flat, w_flat, 2, 4727, 128, 1, 1, 8192)
        return 0